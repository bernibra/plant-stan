...
ordered.categorical.stan <- function(d = NULL,idx=128, variables=c("bio5_", "bio6_","bio12_"), pseudoA=F, loglik=F, splitdata=F){
...
ordered.categorical.stan.zeroinflated <- function(d = NULL,idx=128, variables=c("bio5_", "bio6_","bio12_"), pseudoA=F, loglik=F, splitdata=F){
...
ordered.categorical.stan.gaussian <- function(d = NULL,idx=128, variables=c("bio5_", "bio6_","bio12_"), pseudoA=F, loglik=F, splitdata=F){
