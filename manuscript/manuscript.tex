...
\section*{Results}
% We first use the baseline model to understand how species are distributed along environmental gradient. As expected alpha declines with altitude, implying that the overall...  study the relationship between mean and variance. We found positive relationship... Hypothesis! Similar results were found using binary data. Different species show different correlaitons, invasive present less prevasive... When adding additional covariate, such the second axis of our PCA, this relationship vanishes... (see Supplementary)
