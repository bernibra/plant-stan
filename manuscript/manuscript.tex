...
% TODO list methods
% 1 Pomodoro on long-tail distribution. Present both generalized Gaussian and Student-t and explain how the condition that we want is to have finite variance and a distribution for which the Gaussian is a special case
% 1 Pomodoro on finishing baseline and MMSBM
% 1 Pomodoro on skewed distribution. Here, we want the skewed normal distribution because we can measure skeweness without having discontinuities, the Gaussian is a special case, and the tails are normally distributed (check wiki)
% 1 Pomodoro on finishing baseline and MMSBM
% 1 Pomodoro on finishing long-tail
% 1 Pomodoro on finishing skewed
% 1 Pomodoro on section about variance covariance matrix. Not long, so I can spend time on revising other things
% 1 Pomodoro on section about other possibilities? Calculate correlations? Add other predictors?
